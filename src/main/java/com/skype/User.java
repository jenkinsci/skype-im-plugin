...
public class User extends SkypeObject {
   ...
   public final void askForAuthorization(String messageForAuthorization) throws SkypeException {
        try {
    ...
    public final ChatMessage send(String message) throws SkypeException {
        return SkypeImpl.chat(getId()).send(message);
    }
    ...
    public final VoiceMail voiceMail() throws SkypeException {
        return SkypeImpl.voiceMail(getId());
    }
    ...
    public final void setDisplayName(String newValue) throws SkypeException {
     ...
     public final void setBuddy(String msg) throws SkypeException {
        Utils.setProperty("USER", getId(), "BUDDYSTATUS 2", msg);
    }
    /**
